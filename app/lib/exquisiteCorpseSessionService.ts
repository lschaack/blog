...
export class ExquisiteCorpseSessionService {
  ...
  private async handleAITurnFailure(sessionId: string): Promise<void> {
    ...
    if (newRetryCount <= ExquisiteCorpseSessionService.MAX_AI_RETRIES) {
...
// Singleton instance
let exquisiteCorpseSessionService: ExquisiteCorpseSessionService | null = null;

export const getExquisiteCorpseSessionService = (): ExquisiteCorpseSessionService => {
  if (!exquisiteCorpseSessionService) {
    exquisiteCorpseSessionService = new ExquisiteCorpseSessionService();
  }
  return exquisiteCorpseSessionService;
};
